...
//! 1. the vast majority of content consumption and generation happening on phones
...
//! 1. event-driven architectures which benefit heavily from subscription/watch semantics
//! 
